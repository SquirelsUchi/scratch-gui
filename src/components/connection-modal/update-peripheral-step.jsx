      ...
      <Box className={styles.activityArea}>
        <Box className={styles.scratchLinkHelp}>
          <Box className={styles.scratchLinkHelpStep}>
            ...
            <img className={styles.helpStepImage} src={this.props.connectionSmallIconURL} />
            {
          ...
          <Box className={styles.scratchLinkHelpStep}>
            ...
            <img className={styles.helpStepImage} src={sendUpdateIcon} />
            <FormattedMessage
        ...
        <Box className={styles.bottomArea}>
          {!showResults && (
            <BalancedFormattedMessage
              ...
              defaultMessage={
                'Do not leave or reload Scratch or disconnect your {extensionName} ' + 'until the update is complete.'
              }
            ...
            <Box className={classNames(styles.bottomAreaItem, styles.buttonRow)}>
              ...
              {(showGetReady || showBadResults) && (
                <button className={styles.connectionButton} onClick={this.handleSendUpdate}>
                  ...
                  <img className={styles.buttonIconRight} src={sendUpdateGlyph} />
                </button>
              )}
            </Box>
          )}
