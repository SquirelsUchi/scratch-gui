          ...
          <div className={styles.centeredRow}>
            {props.phase === PHASES.prescan && (
              <React.Fragment>
                ...
                <img className={styles.bluetoothCenteredIcon} src={bluetoothIcon} />
              </React.Fragment>
            )}
            {props.phase === PHASES.pressbutton && (
              <React.Fragment>
                <img className={classNames(styles.radarBig, styles.radarSpin)} src={radarIcon} />
                <img className={styles.connectionTipIcon} src={props.connectionTipIconURL} />
              </React.Fragment>
            )}
        ...
        <Box className={classNames(styles.bottomAreaItem, styles.buttonRow)}>
          ...
          {props.phase === PHASES.pressbutton && (
            <div className={styles.segmentedButton}>
              ...
              <button className={styles.connectionButton} onClick={props.onRefresh}>
                <img className={styles.abortConnectingIcon} src={closeIcon} />
              </button>
            </div>
          )}
          {props.phase === PHASES.notfound && (
          ...
          {showUpdate && (
            ...
            >
              ...
              />
              <img className={styles.buttonIconRight} src={enterUpdateIcon} />
            </button>
          )}
        </Box>
      </Box>
