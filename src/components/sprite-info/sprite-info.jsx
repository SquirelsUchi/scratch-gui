...
class SpriteInfo extends React.Component {
  ...
  render() {
    ...
    const showLabel = (
      <FormattedMessage defaultMessage="Show" description="Sprite info show label" id="gui.SpriteInfo.show" />
    );
    const sizeLabel = (
      ...
      <div className={styles.group}>
        {stageSize === STAGE_DISPLAY_SIZES.large ? (
          <div className={styles.iconWrapper}>
            <img aria-hidden="true" className={classNames(styles.xIcon, styles.icon)} src={xIcon} />
          </div>
        ) : null}
        <Label text="x">
          <BufferedInput
    ...
    const yPosition = (
      <div className={styles.group}>
        {stageSize === STAGE_DISPLAY_SIZES.large ? (
          <div className={styles.iconWrapper}>
            <img aria-hidden="true" className={classNames(styles.yIcon, styles.icon)} src={yIcon} />
          </div>
        ) : null}
        <Label text="y">
          <BufferedInput
