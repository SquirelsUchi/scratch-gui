  ...
  render() {
    return this.props.featured ? (
      ...
      >
        ...
        <div
          className={
            this.props.extensionId ? classNames(styles.featuredExtensionText, styles.featuredText) : styles.featuredText
          }
        >
              ...
              {this.props.bluetoothRequired || this.props.internetConnectionRequired ? (
                <div>
                  ...
                  <div className={styles.featuredExtensionMetadataDetail}>
                    {this.props.bluetoothRequired ? <img src={bluetoothIconURL} /> : null}
                    {this.props.internetConnectionRequired ? <img src={internetConnectionIconURL} /> : null}
                  </div>
                </div>
              ) : null}
            </div>
            <div className={styles.featuredExtensionCollaboration}>
              {this.props.collaborator ? (
                <div>
                  ...
                  <div className={styles.featuredExtensionMetadataDetail}>{this.props.collaborator}</div>
                </div>
              ) : null}
            </div>
          </div>
      ...
      >
        ...
        {this.props.showPlayButton ? (
          <PlayButton isPlaying={this.props.isPlaying} onPlay={this.props.onPlay} onStop={this.props.onStop} />
        ) : null}
      </Box>
    );
  }
