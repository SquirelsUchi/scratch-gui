...
import { validateFileSizeLimit } from '../shared/utils/file-validation/fileValidation.js';
import { validateFileContent } from '../shared/utils/file-validation/contentValidation.js';
import { compressAudio } from '../shared/utils/files-compress/audiosCompress.js';
import SoundLibrary from './sound-library.jsx';
import SoundEditor from './sound-editor.jsx';
import RecordModal from './record-modal.jsx';

const SOUND_FILE_ACCEPT = ['.mp3', '.wav'];
...
class SoundTab extends React.Component {
  ...
  async handleSoundUpload(e) {
    ...
    const validFiles = validateFileSizeLimit(compressedTarget, this.props.onOpenFileExcideModal);
