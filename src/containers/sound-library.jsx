...
class SoundLibrary extends React.PureComponent {
  constructor(props) {
    super(props);
    bindAll(this, ['handleItemSelected', 'handleItemMouseEnter', 'handleItemMouseLeave', 'onStop', 'setStopHandler']);
  ...
  handleItemMouseEnter(soundItem) {
    ...
    this.playingSoundPromise = vm.runtime.storage
      .load(vm.runtime.storage.AssetType.Sound, md5, dataFormat)
      .then((soundAsset) => {
        if (soundAsset) {
          const sound = {
            md5: md5ext,
