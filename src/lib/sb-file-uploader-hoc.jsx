...
import { convertSvgToPng } from '../shared/utils/convertation/convertSvgToPng.js';
import sharedMessages from './shared-messages';

const PROJECT_FILE_ACCEPT = ['.sb3'];
...
const SBFileUploaderHOC = function (WrappedComponent) {
  class SBFileUploaderComponent extends React.Component {
    ...
    onload() {
      if (this.fileReader) {
        ...
        this.props.vm
          ...
          .then(() => {
            return convertSvgToPng(this.props.vm, this.props.wasmResvgPackage);
          })
          .then(() => {
            loadingSuccess = true;
          })
    ...
    render() {
      ...
      return (
        <React.Fragment>
          <WrappedComponent onStartSelectingFileUpload={this.handleStartSelectingFileUpload} {...componentProps} />
        </React.Fragment>
      );
    }
  }
  ...
  SBFileUploaderComponent.propTypes = {
    ...
    wasmResvgPackage: PropTypes.object
  };
  const mapStateToProps = (state, ownProps) => {
    ...
    return {
      ...
      wasmResvgPackage: state.scratchGui.projectManager.wasmResvgPackage
    };
  };
