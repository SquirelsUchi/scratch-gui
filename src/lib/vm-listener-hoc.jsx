...
const vmListenerHOC = function (WrappedComponent) {
  class VMListener extends React.Component {
    constructor(props) {
      super(props);
      bindAll(this, ['handleKeyDown', 'handleKeyUp', 'handleProjectChanged', 'handleTargetsUpdate']);
    ...
    handleTargetsUpdate(data) {
      if (this.props.shouldUpdateTargets) {
        this.props.onTargetsUpdate(data, this.props.vm);
      }
    }
    handleKeyDown(e) {
  ...
  const mapDispatchToProps = (dispatch) => ({
    onTargetsUpdate: (data, vm) => {
      dispatch(updateTargets(data.targetList, data.editingTarget, vm));
    },
