...
export default {
  ...
  'say-it-out-loud': {
    ...
    steps: [
      {
        video: 'k54n8uwcty',
        trackingPixel: <img src="https://code.org/api/hour/begin_scratch_talk.png" />
      },
      {
        title: (
          <FormattedMessage
  ...
  pong: {
    name: (
      <FormattedMessage defaultMessage="Pong Game" description="Name for the 'Pong Game' how-to" id="gui.howtos.pong" />
    ),
    tags: ['pong', 'game'],
    img: libraryPong,
    category: CATEGORIES.prompts,
  ...
  'cartoon-network': {
    ...
    steps: [
      {
        video: 'uz5oz5h9yg',
        trackingPixel: <img src="https://code.org/api/hour/begin_scratch_adventure.png" />
      },
      {
        title: (
          <FormattedMessage
